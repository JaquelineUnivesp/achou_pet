...
from . import views
from .views import user_pets_list, pet_detail, edit_pet, delete_pet, lost_pet_detail
...
urlpatterns = [
    ...
    # Pets Perdidos (Público - Novo!)
    path('lost_pet/<int:pet_id>/', views.lost_pet_detail, name='lost_pet_detail'),
